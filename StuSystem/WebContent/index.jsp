...
<button class="btn_sign_up" onClick="window.location='admin.jsp';">Admin System</button>
    ...
    <div class="cont_login">
      ...
      <div class="cont_forms" >
        ...
        <div class="cont_form_login" > <a href="#" onClick="ocultar_login_sign_up()" ><i class="material-icons">&#xE5C4;</i></a>
          <h2>LOGIN</h2>
          <input type="text" name="student_name_log" id="student_name_log" placeholder="Student ID_name" />
          <input type="password" name="student_password_log" id="student_password_log" placeholder="Password" />
          <div class="radio">
							<label>
								<input type="radio" name="optionsRadios" id="optionsRadios1" value="1601" checked>1601
							</label>
							<label>
								<input type="radio" name="optionsRadios" id="optionsRadios2" value="1602">1602
							</label>
							<label>
								<input type="radio" name="optionsRadios" id="optionsRadios3" value="1603">1603
							</label>
							<label>
								<input type="radio" name="optionsRadios" id="optionsRadios4" value="1604">1604
							</label>
		  </div>
          <button class="btn_login"  onClick="cambiar_login()">LOGIN</button>
        </div>
