...
//HttpSession session = request.getSession();
	...
	Connection connection = DBUtil.getConnection(className);
	Statement statement;
	...
	ResultSet rs = statement.executeQuery("SELECT * FROM stu_info ORDER BY id ASC");
	//获取记录总数
	rs.last();
...
<div id="xt-left">
    ...
    <div class="xt-menu">
        <ul>
            <li><a href="admin_home1.jsp?page=1" class="hover"><em class="one"></em>Basic Information</a></li>
...
<div id="xt-right">
    ...
    <div class="xt-fenye">
        ...
        <div class="xt-fenye-right">
        	<% if(intPage>1){ %>
            <a href="admin_home1.jsp?page=1">First Page</a>
            <% }else{ %>
            <a href="#">First Page</a>
            <% } %>
            
            <% if(intPage>1){ %>
            <a href="admin_home1.jsp?page=<%=intPage-1%>">Previous Page</a>
            <% }else{ %>
            <a href="#">Previous Page</a>
            <% } %>
            
            <% if(intPage<intPageCount){ %>
            <a href="admin_home1.jsp?page=<%=intPage+1%>">Next Page</a>
            <% }else{ %>
            <a href="#">Next Page</a>
            <% } %>
            
            <% if(intPage<intPageCount){ %>
            <a href="admin_home1.jsp?page=<%=intPageCount%>">Last Page</a>
            <% }else{ %>
            <a href="#">Last Page</a>
            <% } %>         
        </div>
